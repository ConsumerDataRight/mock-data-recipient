...
namespace CDR.DataRecipient.E2ETests.Infrastructure
{
    public class AccessToken
    {
        private static readonly string IDENTITYSERVER_URL = BaseTest_v2.REGISTER_IDENTITYSERVER_URL;
        ...
        public async Task<string?> GetAsync()
        {
            ...
            var accessToken = JsonSerializer.Deserialize<IntegrationTests.Models.AccessToken>(await response.Content.ReadAsStringAsync());
