...
{
    public class US23863_MDR_E2ETests_v3 : BaseTest_v2, IClassFixture<TestFixture>
    {
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC01_HomePage)}", async (page) =>
            {
                // Act - Goto home page
                await page.GotoAsync(WEB_URL);
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC02_01_DiscoverDataHolders_Banking)}", async (page) =>
            {
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC02_02_DiscoverDataHolders_Energy)}", async (page) =>
            {
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC02_03_DiscoverDataHolders_Telco)}", async (page) =>
            {
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC02_04_DiscoverDataHolders_AnyIndustry)}", async (page) =>
            {
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC02_99_DiscoverDataHolders)} - Industry={industry} - Version={version}", async (page) =>
            {
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC03_GetSSA)} - Version={version} - DR_BrandId={drBrandId} - DR_SoftwareProductId={drSoftwareProductId}", async (page) =>
            {
        ...
        public async Task AC04_DynamicClientRegistration(string dhBrandId = DH_BRANDID, string drBrandId = DR_BRANDID, string drSoftwareProductId = DR_SOFTWAREPRODUCTID)
        {
            try
            {
                ...
                await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC04_DynamicClientRegistration)} - DH_BrandId={dhBrandId} - DR_BrandId={drBrandId} - DR_SoftwareProductId={drSoftwareProductId}", async (page) =>
                {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_ViewIDToken)}", async (page, response) =>
            {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_ViewAccessToken)}", async (page, response) =>
            {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_ViewRefreshToken)}", async (page, response) =>
            {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_ViewUserInfo)}", async (page, response) =>
            {
                await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_ViewUserInfo)}", async (page) =>
                {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_Introspect)}", async (page, response) =>
            {
                var expected = new (string, string?)[]
                {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_Refresh_Access_Token)}", async (page, response) =>
            {
                var expected = new (string, string?)[]
                {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_Revoke_Arrangement)}", async (page, response) =>
            {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_Revoke_AccessToken)}", async (page, response) =>
            {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_Revoke_RefreshToken)}", async (page, response) =>
            {
        ...
        {
            await Test_Consents(dhBrandId, drBrandId, drSoftwareProductId, customerId, customerAccounts, $"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC06_Consents_Delete_Local)}", async (page, response) =>
            {
        ...
        public async Task AC07_PAR(string dhBrandId, string drBrandId, string drSoftwareProductId, string customerId, string customerAccounts)
        {
            try
            {
                ...
                await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC07_PAR)}", async (page) =>
                {
                    // Arrange - Goto home page, click menu button, check page loaded
                    await page.GotoAsync(WEB_URL);
                    await page.Locator("a >> text=PAR").ClickAsync();
        ...
        public async Task AC08_ConsumerDataSharing_Banking(string dhBrandId, string drBrandId, string drSoftwareProductId, string customerId, string customerAccounts)
        {
            try
            {
                ...
                await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC08_ConsumerDataSharing_Banking)}", async (page) =>
                {
                    // Arrange - Goto home page, click menu button, check page loaded
                    await page.GotoAsync(WEB_URL);                    
        ...
        public async Task AC08_ConsumerDataSharing_Banking_AccountsGet(string dhBrandId, string drBrandId, string drSoftwareProductId, string customerId, string customerAccounts)
        {
            try
            {
                ...
                await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC08_ConsumerDataSharing_Banking_AccountsGet)}", async (page) =>
                {
                    // Arrange - Goto home page, click menu button, check page loaded
                    await page.GotoAsync(WEB_URL);
                    await page.Locator("span:text(\"Consumer Data Sharing\") + ul >> a:text(\"Banking\")").ClickAsync();
        ...
        public async Task AC08_ConsumerDataSharing_Energy(string dhBrandId, string drBrandId, string drSoftwareProductId, string customerId, string customerAccounts)
        {
            try
            {
                ...
                await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC08_ConsumerDataSharing_Energy)}", async (page) =>
                {
                    // Arrange - Goto home page, click menu button, check page loaded
                    await page.GotoAsync(WEB_URL);
        ...
        public async Task AC08_ConsumerDataSharing_Energy_AccountsGet(string dhBrandId, string drBrandId, string drSoftwareProductId, string customerId, string customerAccounts)
        {
            try
            {
                ...
                await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC08_ConsumerDataSharing_Energy_AccountsGet)}", async (page) =>
                {
                    // Arrange - Goto home page, click menu button, check page loaded
                    await page.GotoAsync(WEB_URL);
                    await page.Locator("span:text(\"Consumer Data Sharing\") + ul >> a:text(\"Energy\")").ClickAsync();
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC09_IDTokenHelper)}", async (page) =>
            {
                // Arrange - Goto home page, click menu button, check page loaded
                await page.GotoAsync(WEB_URL);
        ...
        public async Task AC10_PrivateKeyJWTGenerator()
        {
            ...
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC10_PrivateKeyJWTGenerator)}", async (page) =>
            {
                // Arrange - Goto home page, click menu button, check page loaded
                await page.GotoAsync(WEB_URL);
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC11_Settings)}", async (page) =>
            {
                // Arrange - Goto home page, click menu button, check page loaded
                await page.GotoAsync(WEB_URL);
        ...
        {
            await TestAsync($"{nameof(US23863_MDR_E2ETests_v3)} - {nameof(AC12_About)}", async (page) =>
            {
                // Arrange - Goto home page, click menu button, check page loaded                
                await page.GotoAsync(WEB_URL);
