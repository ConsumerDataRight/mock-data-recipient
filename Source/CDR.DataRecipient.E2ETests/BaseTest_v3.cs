...
namespace CDR.DataRecipient.E2ETests
{
    ...
    public class BaseTest_v3
    {
        ...
        {
            using var connection = new SqlConnection(BaseTest_v3.REGISTER_CONNECTIONSTRING);
            connection.Open();
            ...
            using var updateCommand = new SqlCommand($@"
                    update 
                        softwareproduct
                    set 
                        recipientbaseuri = 'https://{BaseTest_v3.HOSTNAME_DATARECIPIENT}:9001',
                        revocationuri = 'https://{BaseTest_v3.HOSTNAME_DATARECIPIENT}:9001/revocation',
                        redirecturis = 'https://{BaseTest_v3.HOSTNAME_DATARECIPIENT}:9001/consent/callback',
                        jwksuri = 'https://{BaseTest_v3.HOSTNAME_DATARECIPIENT}:9001/jwks'
                    where 
                        softwareproductid = '{BaseTest_v3.DR_SOFTWAREPRODUCTID}'",
                connection);
            ...
            using var updateCommand2 = new SqlCommand($@"
                    update
                        endpoint
                    set 
                        publicbaseuri = 'https://{BaseTest_v3.HOSTNAME_DATAHOLDER}:8000',
                        resourcebaseuri = 'https://{BaseTest_v3.HOSTNAME_DATAHOLDER}:8002',
                        infosecbaseuri = 'https://{BaseTest_v3.HOSTNAME_DATAHOLDER}:8001'
                    where 
                        brandid = '{BaseTest_v3.DH_BRANDID}'",
                connection);
            ...
            using var updateCommand3 = new SqlCommand($@"
                    update
                        endpoint
                    set 
                        publicbaseuri = 'https://{BaseTest_v3.HOSTNAME_DATAHOLDER_ENERGY}:8100',
                        resourcebaseuri = 'https://{BaseTest_v3.HOSTNAME_DATAHOLDER_ENERGY}:8102',
                        infosecbaseuri = 'https://{BaseTest_v3.HOSTNAME_DATAHOLDER_ENERGY}:8101'
                    where 
                        brandid = '{BaseTest_v3.DH_BRANDID_ENERGY}'",
                connection);
        ...
        {
            PurgeIdentityServer(BaseTest_v3.DATAHOLDER_IDENTITYSERVER_CONNECTIONSTRING);
        }

        public static void PurgeMDHEnergyIdentityServer()
        {
            PurgeIdentityServer(BaseTest_v3.DATAHOLDER_ENERGY_IDENTITYSERVER_CONNECTIONSTRING);
        }
