    ...
    public class ConsentController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            if (isSuccessful)
            {
                ...
                var tokenEndpoint = (await _dataHolderDiscoveryCache.GetOidcDiscoveryByInfoSecBaseUri(authState.DataHolderInfosecBaseUri)).PreferentialTokenEndpoint;
        ...
        private async Task<ResponseModel> RefreshAccessToken(string cdrArrangementId)
        {
            ...
            var tokenEndpoint = (await _dataHolderDiscoveryCache.GetOidcDiscoveryByBrandId(arrangement.DataHolderBrandId)).PreferentialTokenEndpoint;
